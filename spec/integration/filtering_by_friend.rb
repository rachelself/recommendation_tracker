RSpec.describe "Filtering entries by friend", :integration do
  ...
  context "valid input" do
    ...
    let!(:entry2){ Entry.create(name:"The Girl's Guide to Homelessness", category: category1, note: "jabba da hut", friend: friend1) }
    ...
    it "prints a success message" do
      expect(output).to include("3 entries found for MaRisa under Books")
    end
